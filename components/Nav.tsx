            ...
            <Box ml={2} display={{base: 'inline-block', md:'none'}}>
                <Menu>
                    <MenuButton as={IconButton} icon={<HamburgerIcon />} variant="outline" aria-label='Options' />
                        <MenuList>
                        <NeLi href='/' passHref>
                            <MenuItem as={Link}><FaHome/>&nbsp;Home</MenuItem>
                        </NeLi>
                        <NeLi href='/projects' passHref>
                            <MenuItem as={Link}><FaProjectDiagram/>&nbsp;Projects</MenuItem>
                        </NeLi>
                        <NeLi href='/blog' passHref>
                            <MenuItem as={Link}><FaBlog/>&nbsp;Blog</MenuItem>
                        </NeLi>
                        <NeLi href='/source' passHref>
                            <MenuItem as={Link}><FaGithubAlt/>&nbsp;Website Source</MenuItem>
                        </NeLi>
                        </MenuList>
                </Menu>
            </Box>
